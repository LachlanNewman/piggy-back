...
Manages database schema evolution using goose. On startup, the backend applies all pending SQL migrations in order before accepting requests, ensuring the schema is always current and consistent with the deployed binary.
